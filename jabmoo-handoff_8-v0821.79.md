...
> อัปเดตล่าสุด: **prod v0821.79 / dev v0821.79-dev** (2026-09-19) — **prod = dev ทุกบรรทัด ยกเว้น 6 บรรทัด dev-only** · A push เองผ่าน GitHub Desktop
...
|---|---|---|
| jabmoo.html | **v0821.79** | prod — COIN_ON=true, ~1.52MB |
| jabmoo-dev.html | **v0821.79-dev** | ต่าง prod **6 บรรทัด**: manifest-dev/icon-dev/ชื่อแอป DEV + `__JM_DEV=true` + VER + COIN_ON gate |
